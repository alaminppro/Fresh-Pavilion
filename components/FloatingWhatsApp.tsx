...
export const FloatingWhatsApp: React.FC<FloatingWhatsAppProps> = ({ phoneNumber }) => {
  ...
  return (
    <button 
      onClick={handleClick}
      className="fixed right-6 top-[85%] -translate-y-1/2 z-[150] w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-all group"
